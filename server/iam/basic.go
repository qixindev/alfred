...
func AddIamRoutes(rg *gin.RouterGroup) {
	...
	rg.GET("/types/:typeId/resources/:resourceId/users", GetResourceUserList)              // 获取某个资源下面用户列表
	...
	rg.POST("/types/:typeId/resources/all/users/:userId/roles/:roleId", CreateAllTypeRole)
}
